...
| channel.ams.groups[0].identifier | string | `"ACCOUNTID"` |  |
| channel.ams.groups[0].value | string | `"paygops"` |  |
| channel.ams.groups[1].identifier | string | `"FOUNDATIONALID"` |  |
| channel.ams.groups[1].value | string | `"roster"` |  |
...
| elasticsearch.clusterHealthCheckParams | string | `"wait_for_status=yellow&timeout=100s"` |  |
| elasticsearch.clusterName | string | `"ph-ee-elasticsearch"` |  |
| elasticsearch.data.readinessProbe.httpGet.path | string | `"/_cluster/health?wait_for_status=yellow&timeout=5s"` |  |
| elasticsearch.data.readinessProbe.httpGet.port | int | `9200` |  |
| elasticsearch.data.readinessProbe.initialDelaySeconds | int | `30` |  |
...
| elasticsearch.master.readinessProbe.httpGet.path | string | `"/_cluster/health?wait_for_status=yellow&timeout=5s"` |  |
| elasticsearch.master.readinessProbe.httpGet.port | int | `9200` |  |
| elasticsearch.master.readinessProbe.initialDelaySeconds | int | `30` |  |
| elasticsearch.minimumMasterNodes | int | `1` |  |
| elasticsearch.replicas | int | `1` |  |
| elasticsearch.resources.limits.cpu | string | `"1000m"` |  |
| elasticsearch.resources.limits.memory | string | `"1024M"` |  |
| elasticsearch.resources.requests.cpu | string | `"200m"` |  |
| elasticsearch.resources.requests.memory | string | `"1024M"` |  |
| elasticsearch.volumeClaimTemplate.accessModes[0] | string | `"ReadWriteOnce"` |  |
| elasticsearch.volumeClaimTemplate.resources.requests.storage | string | `"10Gi"` |  |
| elasticsearch.volumeClaimTemplate.storageClassName | string | `"oaf-storage"` |  |
...
| mpesa.SPRING_PROFILES_ACTIVE | string | `"bb"` |  |
| mpesa.business_short_code | string | `""` |  |
| mpesa.callback_host | string | `"https://paymenthub.qa.oneacrefund.org/mpesa"` |  |
| mpesa.deployment.annotations | object | `{}` |  |
| mpesa.enabled | bool | `true` |  |
| mpesa.hostname | string | `"paymenthub.qa.oneacrefund.org"` |  |
...
| operations_web.image | string | `"oaftech.azurecr.io/phee-ns/ph-ee-operations-app"` |  |
...
| zeebe-operate-helm.global.elasticsearch.clusterName | string | `"ph-ee-elasticsearch"` |  |
| zeebe-operate-helm.global.elasticsearch.host | string | `"ph-ee-elasticsearch"` |  |
